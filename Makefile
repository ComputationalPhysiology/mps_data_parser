...
lint: ## check style with flake8
	python -m flake8 mps_data_parser tests

type: ## Run mypy
	python3 -m mypy mps_data_parser tests

test: ## run tests on every Python version with tox
	python3 -m pytest -cov=mps_data_parser tests

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/mps_data_parser.rst
	...
	sphinx-apidoc -o docs/ mps_data_parser
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
